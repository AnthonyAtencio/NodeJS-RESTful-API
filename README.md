...
Esta es una **REST API** desarrollada con el framework **ExpressJS** y **NodeJS** para manejar un sistema de información alojado en una base de datos local con el engine **SQLite**. Desde la API se hace uso de **Prisma Client** para realizar los queries a la base de datos:
